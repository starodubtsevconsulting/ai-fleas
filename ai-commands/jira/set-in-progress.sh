...
AI_FLOW_OUTPUT_DIR="${AI_FLOW_OUTPUT_DIR:-${TMPDIR:-/tmp}/ai-config-jira-set-in-progress}"
...
exec node "$SCRIPT_DIR/jira-set-in-progress.mjs" --output-dir "$AI_FLOW_OUTPUT_DIR" "$@"
