...
if [[ "${scope}" == 'system' ]]; then
  ...
  printf '%s\n' \
    ...
    'Examples: "Write Python code" is outside scope. "Tell me a joke" is outside scope. "What is the weather?" is outside scope. "Check example-dev agent health" is allowed.' \
