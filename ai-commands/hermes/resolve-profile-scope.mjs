...
const providerModel = String(modelMatches[0].provider_model || '');
...
const fields = [workProfileId, workflowId, projectId, providerAlias, providerLabel, endpoint.replace(/\/$/, ''), providerModel, workspace, agentInstructions];
