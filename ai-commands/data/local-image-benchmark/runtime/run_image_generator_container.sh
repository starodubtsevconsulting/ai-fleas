...
forwarded=(
  ...
  IMAGE_POLICY_MODERATION_TIMEOUT_SECONDS IMAGE_POLICY_MODERATION_AUTH_TOKEN_FILE
  IMAGE_POLICY_BYPASS_CODE_SHA256 IMAGE_POLICY_BYPASS_SESSION_TTL_SECONDS IMAGE_PORT
)
