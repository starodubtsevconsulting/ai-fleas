...
grep -Fq 'IMAGE_POLICY_MODERATION_URL' "$dir/assets/systemd/gx10-qwen-image-generator.service"
...
grep -Fq 'IMAGE_POLICY_PRESET=unrestricted' "$dir/assets/env/qwen-image-generator.env.example"
grep -Fq 'IMAGE_POLICY_SEMANTIC_INPUT=false' "$dir/assets/env/qwen-image-generator.env.example"
