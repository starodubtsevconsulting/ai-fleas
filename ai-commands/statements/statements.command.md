...
`~/data/SynologyDrive/documents/example-business`, and put machine-specific roots in local `statements.command.config` or
pass `--reports-root`.
...
```bash
INCORPORATED_ROOT="${HOME}/data/SynologyDrive/documents/example-business"
