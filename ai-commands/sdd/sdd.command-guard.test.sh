...
mkdir -p "$fixture/ai-commands/sdd" "$fixture/ai-profile/example-profile/.local/work-session-state" \
...
plan="$fixture/ai-profile/example-profile/.local/work-session-state/plan.md"
pointer="$fixture/ai-profile/example-profile/.local/work-session-state/.current-plan-path"
cat > "$plan" <<'PLAN'
