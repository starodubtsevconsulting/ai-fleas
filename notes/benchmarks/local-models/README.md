...
- Treat dual-loaded Qwen3.6 35B NVFP4 as blocked for Hermes worker use until a real 64K serving configuration demonstrates adequate memory headroom and passes the unchanged tool-use fixture. Do not infer coding quality from its short direct-API speed.
