...
|---|---|---|---|---|---|
| Qwen-Image BF16 | Prompt adherence, scene composition, anime, and illustrated-story candidate for the Animation Workflow | Text-to-image | Apache 2.0; commercial model use permitted, with separate output/IP review | [GX10 report](local-image-generation/gx10.md) | Task-approved early evidence: 12 retained images, four cases × three seeds; technically valid and visually promising, but not a full comparative benchmark |
