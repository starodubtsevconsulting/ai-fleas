...
|---|---|---|---|---|---|
| Qwen-Image BF16 | Prompt adherence, scene composition, anime, and illustrated-story candidate for the Max workflow | Text-to-image | Apache 2.0; commercial model use permitted, with separate output/IP review | [GX10 report](local-image-generation/gx10.md) | Full 13-case, three-repetition GX10 corpus in progress; exact revision and runtime pinned |
