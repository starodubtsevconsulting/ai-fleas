...
The result therefore establishes Illustrious XL v2.0 as a credible, fast anime baseline with excellent GX10 resource headroom, but not yet a passing recurring-character production solution. The next experiment should evaluate a separately licensed consistency mechanism or character LoRA as its own candidate; it must not be folded silently into this baseline.
