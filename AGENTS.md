...
| `Delete sc-dev` without a verified binding | A visible name alone cannot identify a logical project, sidebar section, task roster, or platform safely. | Ask for the missing exact scope and perform zero mutation. |
