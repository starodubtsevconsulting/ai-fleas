...
test -r "$ROOT/platforms/gpt-app/agents/initialization.md" || fail "missing GPT initializer"
...
grep -Fq 'id: gpt' "$ROOT/platforms/gpt-app/platform.yml" || fail "GPT platform ID mismatch"
