...
grep -Fq 'base_url: http://127.0.0.1:1234/v1' "${ROOT}/example/commands-config/hermes/config.yml" || fail "Hermes example must use the documented local placeholder endpoint"
