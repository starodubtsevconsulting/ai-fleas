...
if rg -q -i 'jira|private-client|trello|linear' "${COMMON_ROLES}/manager.md" "${AGENTS_ROOT}/init.md" "${AGENTS_ROOT}/workflow-agent-initializer.md" "${AGENTS_ROOT}/shared-execution-routing.md"; then
