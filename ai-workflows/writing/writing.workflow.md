...
When a selected platform has initialized the complete roster under the [common agent contract](../agents.md), the human
addresses Writer, Reviewer, and Release Coordinator directly in sequence. They do not automatically message or transfer
work to one another; each reports the exact artifact, evidence, gate, and suggested next role to the human. The human
chooses the next task. Before initialization, an authorized task may emulate Writer and Release Coordinator steps for
...
- The **Writer** owns intake, drafting, editorial verification, archive maintenance, unpublished destination preparation,
  and resolution of independent critique. The Writer prepares a clean copy and effective article brief for the human
  to pass to Reviewer. It then records the exact article and destination-draft revisions, source trail, visual credits,
  review evidence, and open issues for the human to pass to Release Coordinator.
- The **Reviewer** owns the independent reading and critique within that flow. It must not have drafted or edited the
  ...
  the human for Writer's disposition, not an edited replacement draft or publication approval.
