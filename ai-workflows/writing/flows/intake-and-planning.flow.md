...
4. The task selects the applicable blogging template, writing methods, and review emphasis from the profile's
   `review_preferences` when present, adjusted to the article type, audience, and human brief. Record any override or
