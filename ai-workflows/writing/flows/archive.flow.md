...
3. The task records draft/publication state, destination URL if one exists, explicit publication target (for example,
   Medium profile/home or the exact named Publication), selected topics/tags, independent
