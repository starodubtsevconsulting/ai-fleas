...
assert.match(mediumDraftSkill, /commission one generated candidate/);
assert.match(mediumDraftSkill, /cinematic editorial infographic/);
...
assert.match(reviewerRole, /cinematic human-plus-diagram editorial image/);
...
assert.match(routing, /at most one profile-authorized generated candidate/);
